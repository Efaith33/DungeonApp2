 ...
 ");
        ...
        private static Room GetRoom(int level)
        {
            Room[] rooms =
              ...
              " It's another riddle....",
              " The eight of us go forth, not back, to protect our king from a foe's attack.", "Chess Pawns".ToUpper(), 300),

              new Room (" ?ITS THE RIDDLER? The gig is up Riddler, but first I have a riddle for you" ,
              " I see without seeing. To me, darkness is as clear as daylight...What am I ?", "A Bat".ToUpper(), 400)
